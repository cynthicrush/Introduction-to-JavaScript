...
function annoyingSong(bottlesOfSoda){
    return parseInt(bottlesOfSoda) + " bottles of soda on the wall, " + parseInt(bottlesOfSoda) + " bottles of soda, take one down pass it around " + parseInt(bottlesOfSoda-1) + " bottles of soda on the wall";
  } 
...
function vowelCounter(sentence) {
    if (sentence.includes("aeiouAEIOU"));
}
console.log(vowelCounter("If you are happy and you know it clap your hands."));
